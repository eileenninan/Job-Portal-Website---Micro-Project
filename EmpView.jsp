...
%>
		<table>
			...
			<a onclick="document.getElementById('id01').style.display='block'">Add JOB</a>
					...
					<li>
			<a class="active">View JOB</a>
		</li>
		<li>
			<a href="ViewApplicants.jsp">Applicants</a>
		</li>
		<li>
...
%>
			...
			<td><a href="EmpModify.jsp?edit=<%=rs.getInt(1) %>">Modify</a>/<a href="EmpDelete.jsp?delete=<%=rs.getInt(1) %>">Delete</a></td>
			</tr>
<%

...
%>
		...
		<li>
			<a href="JSView.jsp"> Resume </a>
		</li>
		<li>
			<a href="CompanyProfile.html"> Company Profile</a>
		</li>
		<li>
			<a class="active"> Open Job Offers </a>
		</li>
		<li>
...
<%
		...
		while(rs.next())
		{ if(rs.getString(6).equals("Active")){ flag=1;
%>
...
<br>
<br><br>
		<h2><a onclick="document.getElementById('id02').style.display='block'">Apply</a></h2>
		</center>
			<div id="id02" class="modal">
		<form class="modal-content animate" action="JSApply.jsp" method="post">
			<div class = "login-box">
				<div class="imgcontainer">
